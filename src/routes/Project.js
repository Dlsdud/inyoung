                ...
                <div className="project-content">
                    <div className="Box">
                        ...
                        <div className="Box-info">
                            ...
                            <div className="content">
                                구글의 Teachable Machine의 자세추론 기술을 활용한 헬스 트레이너 <br />
                                스쿼트 자세의 올바름 유무를 판단하여 음성으로 알려줍니다.
                            </div>
                            <hr />
                    ...
                    <div className="Box">
                        ...
                        <div className="Box-info">
                            ...
                            <div className="content">
                                JSP로 만든 액세서리 온라인 판매 사이트 
                                Oracle을 사용하여 상품, 회원목록을 관리
                            </div>
                            <hr />
                            <div className="description">
                                <div className="project-label">주요기능</div>
                                <div className="project-value">회원가입, 로그인, 게시판, 상품 카테고리, 장바구니 담기&삭제, 카카오톡 1대1 상담</div>
                            </div>
                    ...
                    <div className="Box">
                        ...
                        <div className="Box-info">
                            ...
                            <div className="content">
                                포트폴리오 용도로 제작한 React.js 기반의 웹사이트입니다.
                            </div>
                            <hr />
                            <div className="description">
                                <div className="project-label">주요기능</div>
